...
--This query returns the list of subscribers and the corresponding mobile plan they availed.
...
--This query returns the contract details and the type of sim card issued in the contract.
...
--This query returns all the subscribers whose data usage exceeds 5000MB.
